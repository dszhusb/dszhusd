...
export const projectContent = [//hardcoding structures is OK in the short term, but you should replace with a load from json/request
    { //DAISY
        ...
        cContent: [
            [2, "Daisy introduces a whole new mode of engaging  with music. Bridging the gap between a listening device, like a speaker, and a full electronic instrument, Daisy allows casual listeners to modify their listening experience."],
            [1, "Daisy in Context", "../assets/daisy/Hero2.png"],
            [3, "PROJECT OVERVIEW"],
            ...
            [0, "As the final effect might suggest, a major inspiration for Daisy was the “lofi” mixes popular on youtube. These mixes frequently feature rehashes of old songs with accompanying animated gifs and edits. Listeners find a sense of community in the shared appreciation of this curated aesthetic. With Daisy, we aimed to go a step beyond, encouraging listeners to craft their own aesthetic, tuning the mood of their music for the moment, rather than consuming a ready-made experience."],
            [1, "Daisy Construction", "../assets/daisy/construction.png"],
            [3, "PROCESS OVERVIEW"],
            ...
            [1, "Daisy Renders", "../assets/daisy/render.png"],
            [3, "REFLECTION"],
            ...
            [1, "Daisy's Custom PCB", "../assets/daisy/pcb.png"],
        ]
    },
    { //TOBI
        key: "TBI",
